...
**sb_coding**(见名知意)由本人在收集的优秀的skills中,挑选的**优质组合**;是本人在和ai进行vibe coding 过程经过各种翻车总结出一套可行性经验(**特别是开发到一半直接变垃圾**)。在今天vibe coding 环境下,大众对编程智能体开发驾驭能力参差不齐,而**sb_coding**兜住了智能体开发的下限。此skill深受本人青睐，从一个想法到开发一半，再到落地十分平稳。虽然有磕碰，但总体比模型落跑实在强太多,剩下的东西自己想读就读,不想多打字了。
